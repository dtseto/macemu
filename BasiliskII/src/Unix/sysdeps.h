...
/* ARMv6+ and AArch64 support unaligned scalar accesses on the targets used by
 * Basilisk II.  Keep the endian conversion explicit so Clang/GCC can emit
 * REV/REV16 rather than the byte-at-a-time fallback below. */
