...
extern void arm_AND_b(RW1 d, RR1 s);
extern void arm_AND_w(RW2 d, RR2 s);
extern void arm_AND_l(RW4 d, RR4 s);
extern void arm_EOR_b(RW1 d, RR1 s);
extern void arm_EOR_w(RW2 d, RR2 s);
extern void arm_EOR_l(RW4 d, RR4 s);
extern void or_b(RW1 d, RR1 s);
extern void or_w(RW2 d, RR2 s);
extern void or_l(RW4 d, RR4 s);
extern void or_l_ri(RW4 d, IMM i);
extern void arm_ORR_b(RW1 d, RR1 s);
extern void arm_ORR_w(RW2 d, RR2 s);
extern void arm_ORR_l(RW4 d, RR4 s);
extern void legacy_ror_l_ri(RW4 d, IMM i);
